    ...
    if m:
      ...
      if command == '■header':
        ...
        self.mode = 'poem'
          ...
          dst_lines.append('sf.my.info.current_scene = "' + scene + '";\n')
          ...
          if m:
            ...
            dst_lines.append('[iscript]\n')
            dst_lines.append('sf.my.info.current_scene = "' + scene + '";\n')
            dst_lines.append('sf.my.flags.show_' + scene_underbar + '_' + minute + ' = true;\n')
            dst_lines.append('[endscript]\n')
            dst_lines.append('\n')
      elif command == '■bg':
        ...
        if m:
          arg1 = m.group(2)
          line = '[chara_mod_b storage="chara/1/BG_' + arg1 + '.png"]\n'
        ...
        if m:
          arg1 = m.group(2)
          arg2 = m.group(3)
          line = '[chara_mod_s storage="chara/2/' + arg1 + '_' + arg2 + '.png"]\n'
          dst_lines.append(line)
        else:
          line = '[chara_hide_s]\n'
          dst_lines.append(line)
      ...
      if m:
        name = m.group(0)
        if name == '#私':
          dst_lines.append('[layopt layer="message0" visible="true"]\n')
        ...
        if src_line == '-----------------------------------------------------------|-------------------<\n':
          ...
          dst_lines.append('[p_h storage="' + scene + '.ks" target="*h_' + hanasu_id + '" target_else="*h_' + hanasu_id + '_else"]\n')
          dst_lines.append('[_tb_end_text]\n')
    ...
    if mode == 'footer':
      ...
      for i, arg_line in enumerate(arg_lines):
        ...
        if i < len(arg_lines) - 1:
          dst_lines.append('[poem text1="' + texts[0] + '" text2="' + texts[1] + '" text3="' + texts[2] + '" text4="' + texts[3] + '"]\n')
        else:
          dst_lines.append('[poem text1="' + texts[0] + '" text2="' + texts[1] + '" text3="' + texts[2] + '" text4="' + texts[3] + '" text5="' + scene + '" text6="' + title + '" last="true"]\n')
    ...
    for src_line in src_lines:
      if self.mode != '':
        if src_line.startswith('  '):
          ...
          lines = self.__replace_arg_lines(self.mode, self.arg_lines, scene, scene_underbar, series)
